...
# Neoteric private configuration - optional.
$(call inherit-product-if-exists, vendor/neoteric-priv/target/product/neoteric-priv-target.mk)
...
# Microsoft
$(call inherit-product, vendor/neoteric/prebuilt/microsoft/packages.mk)
...
PRODUCT_COPY_FILES += \
    vendor/neoteric/target/config/preinstalled-packages-aospa.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/preinstalled-packages-aospa.xml
